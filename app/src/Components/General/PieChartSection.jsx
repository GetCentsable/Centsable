...
const PieChartSection = ({ weeklyTotal, onUpdateCommunities, onClick }) => {
  ...
  return (
    ...
    >
      <SwiperSlide>
        <div className="bg-white p-6 rounded-lg shadow cursor-pointer md-lg:cursor-default relative h-full w-full">
          <button 
          ...
          {weeklyTotal === 0 ? (
            <div className="loading-spinner-container mt-6 mb-12 flex items-center justify-center h-full">
              <div role="status">
